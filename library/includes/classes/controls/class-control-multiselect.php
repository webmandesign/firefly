...
class Firefly_Control_Multiselect extends WP_Customize_Control {
	...
	public function render_content() {
		if ( ! empty( $this->choices ) && is_array( $this->choices ) ) {
			...
			<label>
				...
				<em><?php esc_html_e( 'Press CTRL key for multiple selection.', 'firefly' ); ?></em>
			</label>
