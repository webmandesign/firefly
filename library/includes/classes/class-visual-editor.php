 ...
 * 20) Custom formats
 */
final class Firefly_Theme_Framework_Visual_Editor {
	 ...
	 */
		...
		public static function add_buttons_row1( $buttons ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_firefly_tf_editor_add_buttons_row1_pre', false, $buttons );
		...
		public static function add_buttons_row2( $buttons ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_firefly_tf_editor_add_buttons_row2_pre', false, $buttons );
	 ...
	 */
		...
		public static function custom_mce_format( $init ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_firefly_tf_editor_custom_mce_format_pre', false, $init );
			...
			// Processing
				...
				// Add custom formats
					...
					$style_formats = (array) apply_filters( 'wmhook_firefly_tf_editor_custom_mce_format', array(

							// Group: Text styles

								100 . 'text_styles' => array(
									'title' => esc_html__( 'Text styles', 'firefly' ),
									'items' => array(

										100 . 'text_styles' . 100 => array(
											'title'    => __( 'Dropcap text', 'firefly' ),
											'selector' => 'p',
											'classes'  => 'dropcap-text',
										),

										100 . 'text_styles' . 110 => array(
											'title'    => esc_html__( 'Uppercase heading or paragraph', 'firefly' ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'uppercase',
										),

										100 . 'text_styles' . 120 => array(
											'title'  => esc_html__( 'Highlighted (marked) text', 'firefly' ),
											'inline' => 'mark',
											'icon'   => 'backcolor',
										),

										100 . 'text_styles' . 130 => array(
											'title'  => esc_html__( 'Small text', 'firefly' ),
											'inline' => 'small',
										),

										100 . 'text_styles' . 140 => array(
											'title'  => esc_html__( 'Superscript', 'firefly' ),
											'icon'   => 'superscript',
											'format' => 'superscript',
										),

										100 . 'text_styles' . 150 => array(
											'title'  => esc_html__( 'Subscript', 'firefly' ),
											'icon'   => 'subscript',
											'format' => 'subscript',
										),

										100 . 'text_styles' . 160 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'firefly' ), 1 ),
											'selector' => 'h2, h3, h4, h5, h6, p',
											'classes'  => 'h1',
										),

										100 . 'text_styles' . 170 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'firefly' ), 2 ),
											'selector' => 'h1, h3, h4, h5, h6, p',
											'classes'  => 'h2',
										),

										100 . 'text_styles' . 180 => array(
											'title'    => sprintf( esc_html_x( 'Heading %d text style', '%d = HTML heading size number.', 'firefly' ), 3 ),
							...
							// Group: Text size
								...
								200 . 'text_sizes' => array(
									'title' => esc_html__( 'Text sizes', 'firefly' ),
									'items' => array(

										200 . 'text_sizes' . 100 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'firefly' ), 1 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-1',
										),

										200 . 'text_sizes' . 110 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'firefly' ), 2 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-2',
										),

										200 . 'text_sizes' . 120 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'firefly' ), 3 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-3',
										),

										200 . 'text_sizes' . 130 => array(
											'title'    => sprintf( esc_html_x( 'Display %d', '%d: Display text size number.', 'firefly' ), 4 ),
											'selector' => 'h1, h2, h3, h4, h5, h6, p',
											'classes'  => 'display-4',
										),
							...
							// Group: Quotes
								...
								300 . 'quotes' => array(
									'title' => esc_html_x( 'Quotes', 'Visual editor blockquote formats group title.', 'firefly' ),
									'items' => array(

										300 . 'quotes' . 100 => array(
											'title' => esc_html__( 'Blockquote', 'firefly' ),
											'block' => 'blockquote',
											'icon'  => 'blockquote',
										),

										300 . 'quotes' . 110 => array(
											'title'   => esc_html__( 'Pullquote - align left', 'firefly' ),
											'block'   => 'blockquote',
										...
										300 . 'quotes' . 120 => array(
											'title'   => esc_html__( 'Pullquote - align right', 'firefly' ),
											'block'   => 'blockquote',
										...
										300 . 'quotes' . 130 => array(
											'title'  => esc_html_x( 'Cite', 'Visual editor format label for HTML CITE tag used to set the blockquote source.', 'firefly' ),
											'inline' => 'cite',
										),
...
} // /Firefly_Theme_Framework_Visual_Editor
