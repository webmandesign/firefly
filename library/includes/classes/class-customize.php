 ...
 * 30) Customizer core
 */
final class Firefly_Theme_Framework_Customize {
	 ...
	 */
		...
		public static function preview_scripts() {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_firefly_tf_customize_preview_scripts_pre', false );
			...
			// Helper variables
				...
				$theme_options = apply_filters( 'wmhook_firefly_theme_options', array() );
				...
				if ( is_array( $theme_options ) && ! empty( $theme_options ) ) {
					...
					foreach ( $theme_options as $theme_option ) {
						...
						if ( isset( $theme_option['preview_js'] ) && is_array( $theme_option['preview_js'] ) ) {
							...
							$output_single .= "\t" . '}'. "\r\n";
							$output_single .= ');'. "\r\n";
							$output_single  = apply_filters( 'wmhook_firefly_tf_customize_preview_scripts_option_' . $theme_option['id'], $output_single );
			...
			// Output
				...
				if ( $output = trim( $output ) ) {
					echo apply_filters( 'wmhook_firefly_tf_customize_preview_scripts_output', '<!-- Theme custom scripts -->' . "\r\n" . '<script type="text/javascript"><!--' . "\r\n" . '( function( $ ) {' . "\r\n\r\n" . trim( $output ) . "\r\n\r\n" . '} )( jQuery );' . "\r\n" . '//--></script>' );
				}
	 ...
	 */
		...
		public static function customize( $wp_customize ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_firefly_tf_customize_pre', false, $wp_customize );
			...
			// Helper variables
				...
				$allowed_option_types = apply_filters( 'wmhook_firefly_tf_customize_allowed_option_types', array(
						'checkbox',
						'color',
						'hidden',
						'html',
				...
				// To make sure our customizer sections start after WordPress default ones
					...
					$priority = absint( apply_filters( 'wmhook_firefly_tf_customize_priority', 200 ) );
				 ...
				 */
				$type = apply_filters( 'wmhook_firefly_tf_customize_type', 'theme_mod' );
			...
			// Processing
				...
				// Custom controls
					...
					locate_template( FIREFLY_LIBRARY_DIR . 'includes/classes/controls/class-control-image.php',       true );
						...
						foreach ( $theme_options as $theme_option ) {
							...
							if (
								...
								if ( isset( $theme_option['in_panel'] ) ) {
									...
									$panel_id = apply_filters( 'wmhook_firefly_tf_customize_panel_id', $panel_id, $theme_option, $theme_options );
								...
								switch ( $theme_option['type'] ) {
									...
									case 'radio':
										...
										$wp_customize->add_setting(
												...
												array(
													...
													'default'              => $default,
													'transport'            => $transport,
													'sanitize_callback'    => ( 'checkbox' === $theme_option['type'] ) ? ( 'Firefly_Theme_Framework_Customize::sanitize_checkbox' ) : ( 'Firefly_Theme_Framework_Customize::sanitize_select' ),
													'sanitize_js_callback' => ( 'checkbox' === $theme_option['type'] ) ? ( 'Firefly_Theme_Framework_Customize::sanitize_checkbox' ) : ( 'Firefly_Theme_Framework_Customize::sanitize_select' ),
												)
											);
									...
									case 'hidden':
										...
										$wp_customize->add_control( new Firefly_Control_Hidden(
												$wp_customize,
												$option_id,
												array(
													'label'    => 'HIDDEN FIELD',
									...
									case 'html':
										...
										$wp_customize->add_control( new Firefly_Control_HTML(
												$wp_customize,
												$option_id,
												array(
									...
									case 'multiselect':
										...
										$wp_customize->add_setting(
												...
												array(
													...
													'default'              => $default,
													'transport'            => $transport,
													'sanitize_callback'    => ( isset( $theme_option['validate'] ) ) ? ( $theme_option['validate'] ) : ( 'Firefly_Theme_Framework_Customize::sanitize_return_value' ),
													'sanitize_js_callback' => ( isset( $theme_option['validate'] ) ) ? ( $theme_option['validate'] ) : ( 'Firefly_Theme_Framework_Customize::sanitize_return_value' ),
												)
											);

										$wp_customize->add_control( new Firefly_Control_Multiselect(
												$wp_customize,
												$option_id,
												array(
													'label'           => $theme_option['label'],
									...
									case 'select':
										...
										$wp_customize->add_setting(
												...
												array(
													...
													'default'              => $default,
													'transport'            => $transport,
													'sanitize_callback'    => 'Firefly_Theme_Framework_Customize::sanitize_select',
													'sanitize_js_callback' => 'Firefly_Theme_Framework_Customize::sanitize_select',
												)
											);

										$wp_customize->add_control( new Firefly_Control_Select(
												$wp_customize,
												$option_id,
												array(
													'label'           => $theme_option['label'],
				...
				// Assets needed for customizer preview
					...
					if ( $wp_customize->is_preview() ) {
						...
						add_action( 'wp_footer', 'Firefly_Theme_Framework_Customize::preview_scripts', 99 );
...
} // /Firefly_Theme_Framework_Customize
