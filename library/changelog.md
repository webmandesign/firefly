...
* **Update**: Updating `FIREFLY_INCLUDE_DIR` constant name to `FIREFLY_INCLUDES_DIR`
...
* **Update**: Updating `FIREFLY_INCLUDE_DIR` constant
* **Update**: Library files paths
* **Update**: Theme files paths
...
* **Update**: Renaming `FIREFLY_INC_DIR` constant to `FIREFLY_INCLUDES_DIR`
